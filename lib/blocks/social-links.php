...
namespace PCCFramework\Blocks\SocialLinks;
...
function register_block()
{
    register_block_type(
        ...
        [
            ...
            'render_callback' => '\\PCCFramework\\Blocks\\SocialLinks\\render_callback',
            'attributes' => [
    ...
    $social = [
        'facebook' => [
            'label' =>
                ...
                __('Platform Cooperativism – Discussion & Linkshare', 'pcc-framework'),
        ...
        'twitter' => [
            'label' =>
                ...
                __('Platform Co-op Development Kit', 'pcc-framework'),
